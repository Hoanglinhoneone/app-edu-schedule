...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final WebviewLibraryAccessors laccForWebviewLibraryAccessors = new WebviewLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>pullrefresh</b> with <b>dev.materii.pullrefresh:pullrefresh</b> coordinates and
     * with version reference <b>pullrefresh</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getPullrefresh() {
        return create("pullrefresh");
    }
    ...
    /**
     * Group of libraries at <b>webview</b>
     */
    public WebviewLibraryAccessors getWebview() {
        return laccForWebviewLibraryAccessors;
    }
    ...
    public static class AndroidxHiltLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hiltWorkVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getWork() {
    ...
    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>extended.icons</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getIcons() {
            return create("androidx.material3.icons");
        }
    ...
    public static class SquareupLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getInterceptor() {
            return create("squareup.interceptor");
        }
    ...
    public static class WebviewLibraryAccessors extends SubDependencyFactory {

        public WebviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kevinnzou</b> with <b>io.github.kevinnzou:compose-webview</b> coordinates and
         * with version reference <b>webview</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKevinnzou() {
            return create("webview.kevinnzou");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final ExtendedVersionAccessors vaccForExtendedVersionAccessors = new ExtendedVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>credentialsPlayServicesAuth</b> with value <b> 1.5.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>gmsGoogleServices</b> with value <b>4.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltWorkVersion</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHiltWorkVersion() { return getVersion("hiltWorkVersion"); }
        ...
        /**
         * Version alias <b>pullrefresh</b> with value <b>1.4.0-beta03</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>webview</b> with value <b>0.33.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWebview() { return getVersion("webview"); }
        ...
        /**
         * Group of versions at <b>versions.extended</b>
         */
        public ExtendedVersionAccessors getExtended() {
            return vaccForExtendedVersionAccessors;
        }
    ...
    public static class ExtendedVersionAccessors extends VersionFactory  {

        public ExtendedVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>extended.icons</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIcons() { return getVersion("extended.icons"); }
    ...
    public static class NavVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>nav.version</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GmsGooglePluginAccessors extends PluginFactory {
         ...
         * with version reference <b>gmsGoogleServices</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
